...
suffix = "lecardv2_sample"
# 示例调用
query_path = f'../lecardv2-doc/{suffix}.json'
...
case_corpus_path = '/home/ubuntu/JuDGE_edit/lecardv2-doc/lecardv2-doc_all.json'

# turth_corpus_path = '../lecardv2-doc/lecardv2-doc.json'
...
jsonl_file_path = f'../train/{suffix}_ljp_nosearch.json'
queryId_to_ljp = build_case_id_text_mapping(case_corpus_path)

queryId_to_qw = build_query_id_qw_mapping(query_path)
# id_to_turth = build_case_id_text_mapping(turth_corpus_path)
...
"""
        ...
        # print('-'* 100)
        # 将判决书内容写入 JSONL 文件
        # ljp_res_tuple = id_to_turth[query_id]
        ...
        result_text = queryId_to_qw[query_id]
