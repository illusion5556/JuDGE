...
class MetricsCalculator:
    def __init__(self, gen_file):
        ...
        self.gen_data = self.load_cail_data(gen_file)
        self.exp_data = self.load_data('/home/ubuntu/JuDGE_edit/output/baseline_lecardv2/qwen-ljp/trans_res.json')
    ...
    def load_cail_data(self, file_path):
        with open(file_path, 'r') as file:
            lines = json.load(file)
            exp_data = {}
            gen_data = {}
    ...
    def calc_metrics(self):
        for exp_id, exp_ans in self.exp_data.items():
            ...
            gen_crime = get_crime_our([gen_ans['charge']])
            gen_time = gen_ans['penalty']
            gen_amount = 0
            gen_penalcode_index = [gen_ans['law']]
