...
class MetricsCalculator:
    ...
    def calc_metrics(self):
        ...
        for exp_id, exp_ans in self.exp_data.items():
            ...
            dic = {"exp_crime": str(exp_crime),"exp_time": str(exp_time), "exp_amount": str(exp_amount), "exp_penalcode_index": str(exp_penalcode_index)}
            res.append(dic)
        ...
        # with open("test_exp_ljp.json", "w") as f:
