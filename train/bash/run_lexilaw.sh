...
EPOCH=3
LR=1e-4
MODEL_PREFIX="/liuzyai04/thuir/yuebaoqing/LLM/LexiLaw/model"
OUT_DIR_PREFIX="/liuzyai04/thuir/yuebaoqing/casegen/model/finetune/"
...
for MODEL_NAME in "${MODEL_NAMES[@]}"; do
    ...
    deepspeed --include="localhost:3,4,6,7" --master_port=11469 src/train.py \
