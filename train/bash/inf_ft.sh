...
CUDA_VISIBLE_DEVICES=0 python inf_ft.py --suffix 7b_ins_ep3 --output_path ../../output/sft --model_path /home/ubuntu/weight/wubinglin/judge_ft/full_sft/&
CUDA_VISIBLE_DEVICES=1 python inf_ft.py --suffix 3b_ins_ep3 --output_path ../../output/sft --model_path /home/ubuntu/weight/wubinglin/judge_ft/full_sft/&
